...
{
	static uint16_t last_gray_state;
	...
	{
		gray_status[0]=9; road_miss_cnt/=2;if(road_miss_flag==1)	road_restore_flag=1;return;
	}
	gray_state.state=0x0000;	
	...
	switch(gray_state.state)
	{
		case 0x0001:{gray_status[0]=-12;road_miss_cnt/=2;if(road_miss_flag==1)	road_restore_flag=1;} break;									//000000000001b
		case 0x0003:{gray_status[0]=-11;road_miss_cnt/=2;if(road_miss_flag==1)	road_restore_flag=1;} break;									//000000000011b
		case 0x0002:{gray_status[0]=-10; road_miss_cnt/=2;if(road_miss_flag==1)	road_restore_flag=1;} break;									//000000000010b
		case 0x0007:{gray_status[0]=-9; road_miss_cnt/=2;if(road_miss_flag==1)	road_restore_flag=1;} break;									//000000000111b
		case 0x0006:{gray_status[0]=-9; road_miss_cnt/=2;if(road_miss_flag==1)	road_restore_flag=1;} break;									//000000000110b
		case 0x0004:{gray_status[0]=-8; road_miss_cnt/=2;if(road_miss_flag==1)	road_restore_flag=1;} break;									//000000000100b
		...
		case 0x0700:{gray_status[0]= 8; road_miss_cnt/=2;if(road_miss_flag==1)	road_restore_flag=1;} break;									//011100000000b
		case 0x0600:{gray_status[0]= 9; road_miss_cnt/=2;if(road_miss_flag==1)	road_restore_flag=1;} break;									//011000000000b
		case 0x0400:{gray_status[0]= 9; road_miss_cnt/=2;if(road_miss_flag==1)	road_restore_flag=1;} break;									//010000000000b
		case 0x0E00:{gray_status[0]= 10; road_miss_cnt/=2;if(road_miss_flag==1)	road_restore_flag=1;} break;									//111000000000b
		case 0x0C00:{gray_status[0]= 11;road_miss_cnt/=2;if(road_miss_flag==1)	road_restore_flag=1;} break;									//110000000000b
		case 0x0800:{gray_status[0]= 12;road_miss_cnt/=2;if(road_miss_flag==1)	road_restore_flag=1;} break;									//100000000000b
